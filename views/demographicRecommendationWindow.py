...
class Ui_DemoRecomWindow(object):
    ...
    def show_user_info(self):
        ...
        msg.setDetailedText(demo.user_type.print_type_preferences())
    ...
    def retranslateUi(self, DemoRecomWindow):
        ...
        self.usernameLabel.setText(_translate("DemoRecomWindow", "Username:"))
        self.usernameValueLabel.setText(_translate("DemoRecomWindow", ""))
        self.userIdLabel.setText(_translate("DemoRecomWindow", "ID"))
        ...
        self.imageLabel.setText(_translate("DemoRecomWindow", "UNABLE TO LOAD IMAGE"))
        self.titleLabel.setText(_translate("DemoRecomWindow", "Title"))
        self.yearLabel.setText(_translate("DemoRecomWindow", "(year)"))
        self.label_3.setText(_translate("DemoRecomWindow", "User scores"))
