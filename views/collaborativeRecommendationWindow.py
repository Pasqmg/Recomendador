...
class Ui_CollabRecomWindow(object):
    ...
    def retranslateUi(self, CollabRecomWindow):
        ...
        self.usernameLabel.setText(_translate("CollabRecomWindow", "Username:"))
        self.usernameValueLabel.setText(_translate("CollabRecomWindow", ""))
        self.userIdLabel.setText(_translate("CollabRecomWindow", "ID"))
